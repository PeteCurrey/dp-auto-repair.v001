        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[
                { title: "Mechanic in Chesterfield", desc: "Honest advice, clear pricing, and quality repairs.", href: "/mechanic-chesterfield" },
                { title: "Oil Change in Chesterfield", desc: "Fast oil & filter changes using correct spec oil.", href: "/oil-change-chesterfield" },
                { title: "Brake Repair in Chesterfield", desc: "Pads, discs, fluid and ABS diagnostics.", href: "/brake-repair-chesterfield" },
                { title: "Clutch Replacement in Chesterfield", desc: "Fixed quotes on quality clutch replacements.", href: "/clutch-replacement-chesterfield" },
                { title: "Exhaust Repair & Replacement", desc: "Leaks, flexi pipes, boxes and catalysts.", href: "/exhaust-replacement-chesterfield" },
                { title: "Timing Chain Replacement", desc: "Full kits with guides and tensioners.", href: "/timing-chain-replacement-chesterfield" }
              ].map((item) => (
