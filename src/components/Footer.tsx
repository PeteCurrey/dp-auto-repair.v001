          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
              ...
              <p className="text-xs opacity-60">
                <span className="font-buongiorno text-sm">PeterACurrey</span> <span className="font-montserrat font-extralight">Signature Build by</span> <a href="https://avorria.com" target="_blank" rel="noopener noreferrer" className="font-montserrat font-extralight tracking-wider hover:text-primary transition-colors">AVORRIA</a>
              </p>
            </div>
          </div>
        </div>
